...
BRAILLE_DEF bool braille_2da_get_bit(braille_2da_t arr, unsigned x, unsigned y) { return braille_get_bit(braille_2da_get_braille(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT))); }
BRAILLE_DEF void braille_2da_assign_bit(braille_2da_t arr, unsigned x, unsigned y, bool value) { *braille_2da_get_braille_ptr(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)) = braille_assign_bit(braille_2da_get_braille(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT)), value); }
BRAILLE_DEF void braille_2da_set_bit(braille_2da_t arr, unsigned x, unsigned y) { *braille_2da_get_braille_ptr(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)) = braille_set_bit(braille_2da_get_braille(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT))); }
BRAILLE_DEF void braille_2da_clear_bit(braille_2da_t arr, unsigned x, unsigned y) { *braille_2da_get_braille_ptr(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)) = braille_clear_bit(braille_2da_get_braille(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT))); }
BRAILLE_DEF void braille_2da_toggle_bit(braille_2da_t arr, unsigned x, unsigned y) { *braille_2da_get_braille_ptr(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)) = braille_toggle_bit(braille_2da_get_braille(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT))); }
...
BRAILLE_DEF void braille_2da_copy_bit_rect_into(braille_2da_t arr, braille_2da_t out, unsigned x, unsigned y, unsigned w, unsigned h, unsigned ox, unsigned oy) { if (!(x % BRAILLE_WIDTH == ox % BRAILLE_WIDTH && y % BRAILLE_HEIGHT == oy % BRAILLE_HEIGHT)) for (unsigned i = 0; i < w; ++i) for (unsigned j = 0; j < h; ++j) braille_2da_assign_bit(out, ox + i, oy + j, braille_2da_get_bit(arr, x + i, y + j)); else { unsigned  X =  x / BRAILLE_WIDTH  + ( x % BRAILLE_WIDTH  != 0); unsigned  Y =  y / BRAILLE_HEIGHT + ( y % BRAILLE_HEIGHT != 0); unsigned OX = ox / BRAILLE_WIDTH  + (ox % BRAILLE_WIDTH  != 0); unsigned OY = oy / BRAILLE_HEIGHT + (oy % BRAILLE_HEIGHT != 0); unsigned  W = (x + w) / BRAILLE_WIDTH  - X; unsigned  H = (y + h) / BRAILLE_HEIGHT - Y; braille_2da_copy_braille_rect_into(arr, out, X, Y, W, H, OX, OY); for (unsigned j = 0; j < h; ++j) { for (unsigned i = 0; i < X * BRAILLE_WIDTH - x; ++i) braille_2da_assign_bit(out, ox + i, oy + j, braille_2da_get_bit(arr, x + i, y + j)); for (unsigned i = 0; i < (x + w) - (X + W) * BRAILLE_WIDTH; ++i) braille_2da_assign_bit(out, (OX + W) * BRAILLE_WIDTH + i, oy + j, braille_2da_get_bit(arr, (X + W) * BRAILLE_WIDTH + i, y + j)); } for (unsigned i = 0; i < W * BRAILLE_WIDTH; ++i) { for (unsigned j = 0; j < Y * BRAILLE_HEIGHT - y; ++j) braille_2da_assign_bit(out, OX * BRAILLE_WIDTH + i, oy + j, braille_2da_get_bit(arr, X * BRAILLE_WIDTH + i, y + j)); for (unsigned j = 0; j < (y + h) - (Y + H) * BRAILLE_HEIGHT; ++j) braille_2da_assign_bit(out, OX * BRAILLE_WIDTH + i, (OY + H) * BRAILLE_HEIGHT + j, braille_2da_get_bit(arr, X + BRAILLE_WIDTH + i, (Y + H) * BRAILLE_HEIGHT + j)); } } }
...
BRAILLE_DEF bool wchar_braille_2da_get_bit(wchar_braille_2da_t arr, unsigned x, unsigned y) { return wchar_braille_get_bit(wchar_braille_2da_get_wchar_braille(arr, (unsigned char) ((unsigned char) (x / BRAILLE_WIDTH)), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT))); }
BRAILLE_DEF void wchar_braille_2da_assign_bit(wchar_braille_2da_t arr, unsigned x, unsigned y, bool value) { *wchar_braille_2da_get_wchar_braille_ptr(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)) = wchar_braille_assign_bit(wchar_braille_2da_get_wchar_braille(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT)), value); }
BRAILLE_DEF void wchar_braille_2da_set_bit(wchar_braille_2da_t arr, unsigned x, unsigned y) { *wchar_braille_2da_get_wchar_braille_ptr(arr, (unsigned char) (x / BRAILLE_WIDTH), y / BRAILLE_HEIGHT) = wchar_braille_set_bit(wchar_braille_2da_get_wchar_braille(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT))); }
BRAILLE_DEF void wchar_braille_2da_clear_bit(wchar_braille_2da_t arr, unsigned x, unsigned y) { *wchar_braille_2da_get_wchar_braille_ptr(arr, (unsigned char) (x / BRAILLE_WIDTH), y / BRAILLE_HEIGHT) = wchar_braille_clear_bit(wchar_braille_2da_get_wchar_braille(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT))); }
BRAILLE_DEF void wchar_braille_2da_toggle_bit(wchar_braille_2da_t arr, unsigned x, unsigned y) { *wchar_braille_2da_get_wchar_braille_ptr(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)) = wchar_braille_toggle_bit(wchar_braille_2da_get_wchar_braille(arr, (unsigned char) (x / BRAILLE_WIDTH), (unsigned char) (y / BRAILLE_HEIGHT)), braille_bit_index_2d((unsigned char) (x % BRAILLE_WIDTH), (unsigned char) (y % BRAILLE_HEIGHT))); }
